...
c
      if (iflag_bf.eq.10) then
        f(1) = -(6.d0*xmi+2.d0*xlam)/10.d0
        f(2) = -(6.d0*xmi+2.d0*xlam)/10.d0        
        goto 1000
      endif
c
c
      ...
      xy(2) = y
c      
      if (iflag_bf.eq.30) then
        f(1) =
     .  -xmi*3.75d0*(xy(1)*xy(2)**3+xy(1)**3*xy(2)-2.d0*xy(1)*xy(2))
     .  -(xlam+xmi)*3.75d0*xy(1)*(xy(2)**3-xy(2))
     .  -(xlam+xmi)*0.625d0*(3.d0*xy(1)**2-1.d0)*(3.d0*xy(2)**2-1.d0) 
        f(2) =
     .  -xmi*3.75d0*(xy(1)*xy(2)**3+xy(1)**3*xy(2)-2.d0*xy(1)*xy(2))
     .  -(xlam+xmi)*3.75d0*xy(1)*(xy(2)**3-xy(2))
     .  -(xlam+xmi)*0.625d0*(3.d0*xy(1)**2-1.d0)*(3.d0*xy(2)**2-1.d0)
